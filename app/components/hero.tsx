...
const Hero: React.FC<HeroProps> = () => {
  return (
    <div className="text-center w-full h-screen flex justify-center items-center">
      <div className="bg-neutral-900 text-white w-5/6 h-5/6 flex items-center justify-center rounded-3xl p-6">
        <div className="flex flex-col lg:flex-row items-center justify-evenly space-y-6 lg:space-y-0 lg:space-x-8">
          ...
          <div className="flex flex-col items-center lg:items-start w-full lg:w-1/2 p-4">
            <h1 className="text-2xl font-bold lg:text-4xl xl:text-3xl text-white leading-snug">
              Hi, I&apos;m Ryad
            </h1>
            <h2 className="mt-2 text-xl font-semibold lg:text-2xl text-white">
